...
const Features = () => {
    return (
        <div id='features' className='w-4/5 pt-[80px] m-auto flex flex-col gap-16  pb-32'>
            ...
            <div className='grid grid-cols-1 2xl:flex mt-14 gap-10  items-center  '>

                <div className='border-2 border-none bg-[#EDEDFA] pt-16 mx-auto pl-5 py-10 w-3/4  rounded-[20px] xl:w-[60%] '>
                ...
                <div className='border-2 border-[#EDEDFA] py-10 rounded-[20px] w-[70%] mx-auto'>
                    <img src={features1} alt=''  className=' '/>
            ...
            <div className='grid grid-cols-1 gap-4 2xl:grid-cols-3 2xl:flex m-auto'>

                <div className='border-2  border-[#EDEDFA] rounded-[30px] '>
                    <div><img src={features2} alt=''  className='w-[670px]'/></div>
                ...
                <div className='border-2  border-[#EDEDFA] rounded-[30px] '>
                    <div><img src={features3} alt='' className='h-[400px] max-h-full w-[670px]' /></div>
                ...
                <div className='border-2 border-[#EDEDFA] rounded-[30px]'>
                    <div><img src={features4} alt='' className='  w-[670px]'/></div>
